...
The project is free to use, its source code is open, and it will 
always remain that way.

Developing software like this requires much more than writing code. 
It also involves:

* Access to AI services for translation and speech processing.
* Hardware for development and testing.
* Testing with different operating systems, audio devices, and applications.
* Documentation, examples, and user support.
* Continuous maintenance, bug fixes, and new features.
...
Thank you for helping make communication between people a little freer.
...
Bitcoin (BTC): 
    bc1qks7gh63cecrald8a97kpuwhlv50gk0cn99c3ep

Ethereum (ETH): 
    0x354f0DC5ebB701a3EF83A946a6F018e9A1e08Fb2

Tron (TRC20): 
    TQNNoXJb8toDHEKiTnLaQP2HNRB6416hxu

Stellar (USD, USDC, USDM, EURMTL): 
    GD3LVH5KMRFPIOSJO2XY3ZHNRHFYLSQWH627IPRN43ZZ5LPUS344KVJY  

PayPal: 
    uncleandyv@gmail.com
